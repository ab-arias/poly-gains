  ...
  return (
    <div className="workout-modal-screen">
      <div className="workout-modal-header">
        <button className="workout-modal-close" onClick={() => toggle()}>
          x
        </button>
        {editing ? (
          <input
        ...
        <button className="workout-modal-edit" onClick={handleModeToggle}>
          {editing ? "Save" : "Edit"}
        </button>
      </div>
      <div className="workout-modal-container">
        ...
        {editing && (
          <button onClick={handleExerciseSubmission}>Add New Exercise</button>
        )}
      </div>
    </div>
  );
